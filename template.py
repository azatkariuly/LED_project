...
class TabbedApp(QWidget):
    ...
    def create_tabs(self):
        ...
        label_x_axis = QLabel("x시작점:", self.tab1)
        self.input_x_axis = QLineEdit(self.tab1)
        self.input_x_axis.setPlaceholderText(str(self.x_axis))
        self.input_x_axis.textChanged.connect(self.validate_x_axis)
        
        label_y_axis = QLabel("y시작점:", self.tab1)
        self.input_y_axis = QLineEdit(self.tab1)
        self.input_y_axis.setPlaceholderText(str(self.y_axis))
        self.input_y_axis.textChanged.connect(self.validate_y_axis)

        label_video_width = QLabel("넓이:", self.tab1)
        self.input_video_width = QLineEdit(self.tab1)
        self.input_video_width.setPlaceholderText(str(self.video_width))
        self.input_video_width.textChanged.connect(self.validate_video_width)

        label_video_height = QLabel("높이:", self.tab1)
        self.input_video_height = QLineEdit(self.tab1)
        self.input_video_height.setPlaceholderText(str(self.video_height))
        ...
        load_button = QPushButton("Load Videos", self.tab1)
        load_button.clicked.connect(self.load_videos)
        self.play_button = QPushButton("Play", self.tab1)
        self.play_button.clicked.connect(self.play_video)
        self.play_button.setVisible(False)
        self.pause_button = QPushButton("Pause", self.tab1)
        self.pause_button.clicked.connect(self.pause_video)
        self.pause_button.setVisible(False)
        self.stop_button = QPushButton("Stop", self.tab1)
        ...
        label_power_size_selector = QLabel("번동영역:", self.tab1)
        ...
        label_power_brightness = QLabel("Brightness:", self.tab1)
        self.input_power_brigthness = QLineEdit(self.tab1)
        ...
        label_power_contrast = QLabel("Contrast:", self.tab1)
        self.input_power_contrast = QLineEdit(self.tab1)
        ...
        # self.tab2_label = QLabel("This is the content of Tab 2", self.tab2)
        # tab2_layout.addWidget(self.tab2_label)
